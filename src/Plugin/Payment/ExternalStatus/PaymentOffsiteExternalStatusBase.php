 ...
 */
abstract class PaymentOffsiteExternalStatusBase extends PluginBase implements ContainerFactoryPluginInterface, PaymentStatusInterface, PluginFormInterface, ConfigurablePluginInterface {
